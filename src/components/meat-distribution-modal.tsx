    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Please confirm the meat distribution status for this member.</DialogDescription>
        </DialogHeader>

        <Card className={`${isMarkingTaken ? "bg-green-50 border-green-200" : "bg-red-50 border-red-200"}`}>
          <CardContent className="p-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>Action: {isMarkingTaken ? "Mark as meat taken" : "Mark as meat not taken"}</span>
              </div>

              <div className="p-3 rounded-lg bg-background border">
                <p className="text-sm font-medium mb-1">
                  {isMarkingTaken ? "Confirming Meat Distribution" : "Removing Meat Distribution"}
                </p>
